...
START_TEST (test_in_sti)
{
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem->next->next->next->next->next->next), 0x107EC6D1);
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem->next->next->next->next->next), 0x63A30EE4);
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem->next->next->next->next->next), (int) 0x9751E05F);
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem->next->next->next), (int) 0xBC455823);
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem->next->next->next->next), 0x7A4FB5ED);
	...
	in_sti(NULL, process);
	ck_assert_int_eq(mem_read_dir(mem), (int) 0xD967F460);
