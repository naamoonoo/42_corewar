...
VM_OBJS=$(addprefix $(BIN_DIR), mem.o scheduler.o mem_block.o process.o \
		in_live.o in_ld.o in_add.o in_sub.o \
		in_st.o in_and.o in_or.o in_xor.o \
		in_zjmp.o in_ldi.o in_lld.o in_lldi.o \
		in_fork.o in_lfork.o)
COMMON_OBJS=$(addprefix $(BIN_DIR), op.o)
TEST_OBJS=$(addprefix $(BIN_DIR), test_mem.o test_scheduler.o test_mem_block.o test_process.o \
		  ...
		  test_in_fork.o test_in_lfork.o)
